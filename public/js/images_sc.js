...
__WEBPACK_IMPORTED_MODULE_0_jquery__(function () {
    __WEBPACK_IMPORTED_MODULE_0_jquery__["ajaxSetup"]({
        headers: { 'X-CSRF-TOKEN': __WEBPACK_IMPORTED_MODULE_0_jquery__('meta[name="_token"]').attr('content') }
    });
});
...
function imgReload(itmId) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__('#inp_submit').on('click', function (e) {
...
function readURL(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            __WEBPACK_IMPORTED_MODULE_0_jquery__('#upl_img').attr('src', e.target.result);
        };
        reader.readAsDataURL(input.files[0]);
    }
}
__WEBPACK_IMPORTED_MODULE_0_jquery__("#img_new").change(function () {
    readURL(this);
});
...
__WEBPACK_IMPORTED_MODULE_0_jquery__('#new-img-add').on('click', function (e) {
    var item_id = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).children('#item-img-id').val();
